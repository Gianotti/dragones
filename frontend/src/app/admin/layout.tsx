...
const NAV = [
  ...
  { href: "/admin/organizers", label: "Organizadores", Icon: ClipboardIcon },
];
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen flex bg-gray-50 dark:bg-slate-950 transition-colors">
      {/* Sidebar */}
      <aside className="w-56 bg-violet-950 dark:bg-slate-900 border-r border-violet-900 dark:border-slate-800 text-white flex flex-col shrink-0">
              ...
              <Link
                ...
                className={`flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm font-medium transition ${
                  active
                    ...
                    : "text-violet-200 dark:text-slate-400 hover:bg-violet-900 dark:hover:bg-slate-800 hover:text-white dark:hover:text-white"
                }`}
              >
                <Icon />
                {label}
